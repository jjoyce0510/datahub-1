...
public class GmsGraphQLEngine {
     ...
     */
    public static final List<SearchableEntityType<?>> SEARCHABLE_TYPES = ImmutableList.of(
            DATASET_TYPE,
            CORP_USER_TYPE
    );
    /**
     ...
     */
    public static final List<BrowsableEntityType<?>> BROWSABLE_TYPES = ImmutableList.of(
            DATASET_TYPE
    );
